...
export class Sun extends SpaceObject {
    ...
    constructor() {
        ...
        // const geometry = new THREE.SphereGeometry(69.57, 100, 100);
        /*
        this.startTime = Date.now();
        this.uniforms = {
            iGlobalTime: { type: 'f', value: 1.0 },
            iResolution: { type: 'v2', value: new THREE.Vector2() },
            iChannel0:  { type: 't', value:  new THREE.TextureLoader().load('assets/shadertoytextures/tex09.jpg' ) }
        };
        this.uniforms.iChannel0.value.wrapS = this.uniforms.iChannel0.value.wrapT = THREE.RepeatWrapping;

        const commonShader = `varying vec2 vUv;
        void main()
        {
            vUv = uv;
        ...
        void main( )
        {
            ...
            float starGlow	= min( max( 1.0 - dist * ( 1.0 - brightness ), 0.0 ), 1.0 ) - 0.5 ;
